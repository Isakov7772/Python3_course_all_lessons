...
# new_lst = []
# for lst in students:
#     new_lst.append(lst['gender'])
# X = new_lst.count('Male')
# x_2 = new_lst.count('Female')
# print(X)
# print(x_2)
# print((X / (X+x_2)*100 ))
######################################################
...
# numbers = []
# for number in lst:
#     numbers.append(number["age"])
# print(numbers)

# niteger = str(numbers).strip("[]")
# integer = int(niteger.replace(",",""))
# print(integer)
